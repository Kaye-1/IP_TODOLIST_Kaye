...
public class ToDoList {
    ...
    // A method to read the value from user to create a Task object and to add in the ArrayList of Tasks
    ...
    public void listAllTasks(String sortBy) {
        ...
        System.out.println(
                "Total Tasks = " + taskList.size() +
                        ...
                        Messages.RED_TEXT + " Not Compeleted = " + numberOfUncompletedTasks() + Messages.RESET_TEXT +
                        " )");
        Messages.separator('=',75);
